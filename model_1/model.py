...
def SRGAN_g(t_image, is_train=False, reuse=False):
    ...
    with tf.variable_scope("SRGAN_g", reuse=reuse) as vs:
        ...
        n = Conv2d(n, 1, (3, 3), (1, 1), act=None, padding='SAME', W_init=w_init, name='n256s1/1')
        return n
...
def SRGAN_d(input_images, is_train=True, reuse=False):
    ...
    with tf.variable_scope("SRGAN_d", reuse=reuse):
        ...
        reshape = ReshapeLayer(net_in, [-1, 512, 512, 1], name = 'reshape')
...
def Vgg19_simple_api(input, reuse, rgb = False):
    """
